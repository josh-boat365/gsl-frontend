...
<form id="stage1Form">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" name="account_number" class="form-control" placeholder="Account Number" onkeypress="return isSeatsNumber(event)" maxlength="13" minlength="13" required>
                                                </div>
                                                </div>
                                                ...
                                                <div class="input-group mb-4">
                                                    ...
                                                    <input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" type="text" name="dob" required>
...
<form id="stage2Form">
        <div class="alert alert-info">
            ...
            <p>A verification code has been sent to the phone number used in opening the account. Kindly enter the code and click Next.</p>
        </div>
        ...
        <div class="input-group mb-3">
            ...
            <input type="text" class="form-control" placeholder="Verification Code" maxlength="6" minlength="6" required onkeydown="upperCaseF(this)">
        </div>
        </div>

        <div class="row">
            <div class="col-12">
                <button type="submit" class="btn btn-lg btn-primary btn-block"><i class="fe fe-arrow-right"></i> Next</button>
           </div>
        </div>
</form>
</div>
...
<form id="stage3Form">
    <div class="form-group">
        ...
        <div class="input-group mb-3">
            <span class="input-group-addon"><svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M18 13h5v7h-5z" opacity=".3"></path><path d="M23 11.01L18 11c-.55 0-1 .45-1 1v9c0 .55.45 1 1 1h5c.55 0 1-.45 1-1v-9c0-.55-.45-.99-1-.99zM23 20h-5v-7h5v7zM2 4h18v5h2V4c0-1.11-.9-2-2-2H2C.89 2 0 2.89 0 4v12c0 1.1.89 2 2 2h7v2H7v2h8v-2h-2v-2h2v-2H2V4zm9 2l-.97 3H7l2.47 1.76-.94 2.91 2.47-1.8 2.47 1.8-.94-2.91L15 9h-3.03z"></path></svg></span>
            <input type="text" class="form-control" placeholder="GHA-XXXXXXXXX-X" maxlength="6" minlength="6" required onkeydown="upperCaseF(this)">
        </div>
        </div>
        <div class="row">
                <div class="col-lg-6 col-sm-12">
                    ...
                    <input type="file" class="dropify" data-default-file="theme/assets/images/Ghana_card_front.jpg" data-height="100"  />
                    </div>
                </div>
                <div class="col-lg-6 col-sm-12">
                    <div class="form-group">
                        <center><label class="form-label">(Upload Back Image)</label></center>
                    <input type="file" class="dropify" data-default-file="theme/assets/images/Ghana_card_back.jpg" data-height="100"  />
                    </div>
                </div>
            ...
            <label class="form-label">Image (PNG, JPEG format only. Maximum file size 5MB) </label>
                ...
                <div class="row">
                    <div class="col-12">
                        <button type="submit" class="btn btn-lg btn-primary btn-block"><i class="fe fe-upload-cloud"></i> Submit Card</button>
                   </div>
                </div>
